...
h1
{
  ...
  <?php require 'Partials/_navuser.php'
   ...
   ?>
    <br>
    <h1>Welcome <?php echo $_SESSION['name'];?> To Library Management System</h1>
    <div class="row">
        <div class="col-md-3" style="margin: 2px 60px ">
        ...
        <div class="col-md-3" style="margin: 10px 200px">
            <div class="card bg-light" style="width: 300px">
    ...
    <div class="row">
        <div class="col-md-3" style="margin: 2px 330px">
            <div class="card bg-light" style="width: 300px">
